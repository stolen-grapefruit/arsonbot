...
q_goal_init_up, _ = compute_IK(0.15, -0.18, 0.15, -60)

q_goal_1, _ = compute_IK(0.194, -0.0, 0.0725, -60)
q_goal_2, _ = compute_IK(0.194, -0.0, 0.15, -60)

q_goal_3, _ = compute_IK(0.244, -0.04, 0.15, -60)
q_goal_4, _ = compute_IK(0.244, -0.04, 0.0825, -60)
q_goal_5, _ = compute_IK(0.244, -0.04, 0.15, -60)

q_goal_6, _ = compute_IK(0.2, -0.08, 0.15, -70)
q_goal_7, _ = compute_IK(0.2, -0.08, 0.0825, -70)
q_goal_8, _ = compute_IK(0.2, -0.08, 0.15, -70)

q_goal_9, _ = compute_IK(0.253, -0.135, 0.15, -70)
q_goal_10, _ = compute_IK(0.252, -0.135, 0.1, -70)
q_goal_11, _ = compute_IK(0.253, -0.135, 0.15, -70)

q_goal_12, _ = compute_IK(0.192, -0.14, 0.15, -60)
q_goal_13, _ = compute_IK(0.193, -0.14, 0.0875, -60)
q_goal_14, _ = compute_IK(0.193, -0.14, 0.15, -60)
